...
def generate_launch_description():
    ...
    # Node for the TableCenterPublisher
    table_center_publisher_node = Node(
        package='robot_commander',
        executable='table_center_publisher',
        name='table_center_publisher',
        output='screen'
    )
