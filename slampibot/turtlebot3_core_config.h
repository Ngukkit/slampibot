...
#include "turtlebot3_burger.h" // This might need to be changed if you use a custom robot type
...
#define WHEEL_NUM                        2 // Logical wheels for differential drive
...
#define TICK2RAD                         0.001533981  // (2 * PI) / 4096 = 0.001533981f (for XL430)

// --- Robot Physical Parameters (Updated for your robot) ---
#define WHEEL_RADIUS                     0.033      // meter (66mm diameter / 2)
#define WHEEL_SEPARATION                 0.167      // meter (distance between left and right wheel centers)

#define MAX_LINEAR_VELOCITY              0.22       // meter/s (TurtleBot3 default, tune based on your robot's actual performance)
#define MIN_LINEAR_VELOCITY              -0.22      // meter/s
#define MAX_ANGULAR_VELOCITY             2.63       // rad/s (Calculated based on 0.22m/s linear, tune based on your robot's actual performance)
#define MIN_ANGULAR_VELOCITY             -2.63      // rad/s
